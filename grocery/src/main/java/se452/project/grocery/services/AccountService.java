...
// /**
// * @param input account
// * @return -1 if account password incorrect, other wise will return account
// uid
// */
...
// boolean verified =
// toHash(hashVal+record.getPassword()).equals(record.getVerified());
...
//
// else if
// (accountRepo.findAccountByEmail(account.getEmail()).getRole().equals(Role.USER))
// {
// return Role.USER;
// }
// }
...
// //each value in byteData worth 2 hexdecimal, so we using 0xff as a mask to
// get the value
