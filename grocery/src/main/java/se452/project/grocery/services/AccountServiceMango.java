...
public class AccountServiceMango {
	...
	public boolean createAccount(AccountMango account) {
		try {
			if (account != null &&
					accountRepo.findAccountMangoByEmail(account.getEmail()) == null &&
					account.getEmail() != null && account.getPassword() != null) {
	...
	public Role getRole(AccountMango account) {
		if (account != null && accountRepo.findAccountMangoByEmail(account.getEmail()) != null) {
