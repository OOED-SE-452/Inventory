 ...
 *  
 *  When switching over from a sql to a nosql, Feng and I switch the uid's of the Account
 *  and Item object to a String, and updated the Entity/Id annotations to Document/Id
 *  
 *  
 *  
 *  
